...
function asBridgeRequest(params: Record<string, unknown>): LinkClawBridgeRequest {
  return {
    ...
    capability: asOptionalString(params.capability),
    capabilities: asOptionalStringArray(params.capabilities),
    source: asOptionalString(params.source),
    freshOnly: asOptionalBoolean(params.freshOnly),
    refresh: asOptionalBoolean(params.refresh),
